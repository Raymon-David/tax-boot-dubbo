package com.foryou.tax.invoiceconsumer.config.exception;
...
public class GlobalExceptionHandler {
    ...
    public JSONObject httpRequestMethodHandler() throws Exception {
        return JsonTools.errorJson(ErrorEnum.E_500);
    }
    ...
    public JSONObject unauthorizedExceptionHandler() throws Exception {
        return JsonTools.errorJson(ErrorEnum.E_502);
    }
    ...
    public JSONObject unauthenticatedException() throws Exception {
        return JsonTools.errorJson(ErrorEnum.E_20011);
    }
}
