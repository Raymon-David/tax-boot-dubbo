...
public class UserController {
    ...
    public JSONObject listUser(HttpServletRequest request) {
        return userProcess.listUser(CommonUtil.request2Json(request));
    }
    ...
    public JSONObject addUser(@RequestBody JSONObject requestJson) {
        ...
        return userProcess.addUser(requestJson);
    }
    ...
    public JSONObject updateUser(@RequestBody JSONObject requestJson) {
        ...
        return userProcess.updateUser(requestJson);
    }

    @RequiresPermissions(value = {"user:add", "user:update"}, logical = Logical.OR)
    @GetMapping("/getAllRoles")
    public JSONObject getAllRoles() {
        return userProcess.getAllRoles();
    }
    ...
    public JSONObject listAllPermission() {
        return userProcess.listAllPermission();
    }
    ...
    public JSONObject addRole(@RequestBody JSONObject requestJson) {
        ...
        return userProcess.addRole(requestJson);
    }
    ...
    public JSONObject updateRole(@RequestBody JSONObject requestJson) {
        ...
        return userProcess.updateRole(requestJson);
    }
    ...
    public JSONObject deleteRole(@RequestBody JSONObject requestJson) {
        ...
        return userProcess.deleteRole(requestJson);
    }
}
